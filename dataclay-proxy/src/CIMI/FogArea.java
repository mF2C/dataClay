...
public class FogArea extends CIMIResource {
	...
	public FogArea(final Map<String, Object> objectData) {
		...
		this.ramTotal = (float) objectData.get("ramTotal");
		this.ramMax = (float) objectData.get("ramMax");
		this.ramMin = (float) objectData.get("ramMin");
		// this.storageUnits = (String) objectData.get("storageUnits");
		this.storageTotal = (float) objectData.get("storageTotal");
		this.storageMax = (float) objectData.get("storageMax");
		this.storageMin = (float) objectData.get("storageMin");
	...
	public void set_numDevices(final int numDevices) {
	...
	public void set_avgProcessingCapacityPercent(final float avgProcessingCapacityPercent) {
		this.avgProcessingCapacityPercent = avgProcessingCapacityPercent;
	}

	public void set_cpuMaxPercent(final float cpuMaxPercent) {
		this.cpuMaxPercent = cpuMaxPercent;
	}

	public void set_cpuMinPercent(final float cpuMinPercent) {
		this.cpuMinPercent = cpuMinPercent;
	}

	public void set_avgPhysicalCores(final int avgPhysicalCores) {
		this.avgPhysicalCores = avgPhysicalCores;
	}

	public void set_physicalCoresMax(final int physicalCoresMax) {
		this.physicalCoresMax = physicalCoresMax;
	}

	public void set_physicalCoresMin(final int physicalCoresMin) {
		this.physicalCoresMin = physicalCoresMin;
	}

	public void set_avgLogicalCores(final int avgLogicalCores) {
		this.avgLogicalCores = avgLogicalCores;
	}

	public void set_logicalCoresMax(final int logicalCoresMax) {
		this.logicalCoresMax = logicalCoresMax;
	}

	public void set_logicalCoresMin(final int logicalCoresMin) {
		this.logicalCoresMin = logicalCoresMin;
	}

	public void set_powerRemainingMax(final String powerRemainingMax) {
		this.powerRemainingMax = powerRemainingMax;
	}

	public void set_powerRemainingMin(final String powerRemainingMin) {
	...
	public void updateAllData(final Map<String, Object> data) {
		...
		if (data.get("ramTotal") != null)
			set_ramTotal((float) data.get("ramTotal"));
		if (data.get("ramMax") != null)
			set_ramMax((float) data.get("ramMax"));
		if (data.get("ramMin") != null)
			set_ramMin((float) data.get("ramMin"));
		if (data.get("storageTotal") != null)
			set_storageTotal((float) data.get("storageTotal"));
		if (data.get("storageMax") != null)
			set_storageMax((float) data.get("storageMax"));
		if (data.get("storageMin") != null)
			set_storageMin((float) data.get("storageMin"));
		...
		if (data.get("physicalCoresMax") != null)
			set_physicalCoresMax((int) data.get("physicalCoresMax"));
		if (data.get("physicalCoresMin") != null)
			set_physicalCoresMin((int) data.get("physicalCoresMin"));
		if (data.get("avgLogicalCores") != null)
			set_avgLogicalCores((int) data.get("avgLogicalCores"));
		if (data.get("logicalCoresMax") != null)
			set_logicalCoresMax((int) data.get("logicalCoresMax"));
		if (data.get("logicalCoresMin") != null)
			set_logicalCoresMin((int) data.get("logicalCoresMin"));
		if (data.get("powerRemainingMax") != null)
			set_powerRemainingMax((String) data.get("powerRemainingMax"));
		if (data.get("powerRemainingMin") != null)
			set_powerRemainingMin((String) data.get("powerRemainingMin"));
	}
