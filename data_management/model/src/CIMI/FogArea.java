...
public class FogArea extends CIMIResource {
	 ...
	 **/
	Map<String, Object> leaderDevice;
	Integer numDevices;
	...
	Double storageMax;
	Double storageMin;
	Double avgProcessingCapacityPercent;
	Double cpuMaxPercent;
	Double cpuMinPercent;
	Integer avgPhysicalCores;
	Integer physicalCoresMax;
	Integer physicalCoresMin;
	Integer avgLogicalCores;
	Integer logicalCoresMax;
	Integer logicalCoresMin;
	String powerRemainingMax;
	String powerRemainingMin;
