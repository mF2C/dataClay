...
public class DeviceDynamic extends CIMIResource {
	...
	private int powerRemainingStatusSeconds; //TODO: It is of type String in resource spec, I think it is a mistake
	...
	public DeviceDynamic(Device device, boolean isLeader, String ramUnits, float ramFree, float ramFreePercent, 
			...
			String wifiAddress, List<Object> ethernetThroughputInfo, List<Object> wifiThroughputInfo,
