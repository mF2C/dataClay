...
public class SharingModel extends CIMIResource {
	...
	public void set_max_apps(final int max_apps) {
	...
	public void set_max_cpu_usage(final int max_cpu_usage) {
		this.max_cpu_usage = max_cpu_usage;
	}

	public void set_max_memory_usage(final int max_memory_usage) {
		this.max_memory_usage = max_memory_usage;
	}

	public void set_max_storage_usage(final int max_storage_usage) {
		this.max_storage_usage = max_storage_usage;
	}

	public void set_max_bandwidth_usage(final int max_bandwidth_usage) {
		this.max_bandwidth_usage = max_bandwidth_usage;
	}

	public void set_battery_limit(final int battery_limit) {
	...
	public void updateAllData(final Map<String, Object> data) {
		...
		if (data.get("max_apps") != null)
			set_max_apps((int) data.get("max_apps"));
		if (data.get("gps_allowed") != null)
			set_gps_allowed((boolean) data.get("gps_allowed"));
		if (data.get("max_cpu_usage") != null)
			set_max_cpu_usage((int) data.get("max_cpu_usage"));
		if (data.get("max_memory_usage") != null)
			set_max_memory_usage((int) data.get("max_memory_usage"));
		if (data.get("max_storage_usage") != null)
			set_max_storage_usage((int) data.get("max_storage_usage"));
		if (data.get("max_bandwidth_usage") != null)
			set_max_bandwidth_usage((int) data.get("max_bandwidth_usage"));
