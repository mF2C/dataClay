...
public class ServiceOperationReport extends CIMIResource {
	...
	public ServiceOperationReport(Map<String, Object> objectData) {
        ...
        this.execution_time = (Float) objectData.get("execution_time");
	}
	...
	public Map<String, Object> getCIMIResourceData() {
		...
		if (this.serviceInstance != null) info.put("serviceInstance", this.serviceInstance);
		if (this.operation != null) info.put("operation", this.operation);
		if (this.execution_time != null) info.put("execution_time", this.execution_time);
		return info;
	}
	...
	public void updateAllData(Map<String, Object> data) {
		...
		if (data.get("operation") != null) set_operation((String) data.get("operation"));
		if (data.get("execution_time") != null) set_execution_time((Float) data.get("execution_time"));
	}
